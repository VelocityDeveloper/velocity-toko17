...
function velocitychild_theme_setup()
{
    ...
    if (class_exists('Kirki')) :
        ...
        Kirki::add_panel('panel_toko17', [
            'priority'    => 10,
            'title'       => esc_html__('Toko 17', 'justg'),
...
add_action('justg_header', 'justg_header_toko17');
function justg_header_toko17()
{
    require_once(get_stylesheet_directory() . '/inc/part-header.php');
}
add_action('justg_do_footer', 'justg_footer_toko17');
function justg_footer_toko17()
{
...
add_action('velocitytoko_product_loop', 'velocitytoko17_content_product', 30);
function velocitytoko17_content_product($post)
{
    if (is_singular('product')) :
        $class = 'col-6 mb-2';
    else :
        ...
        <div class="card h-100 card-product p-2 overflow-hidden">
            ...
            <div class="card-body text-center position-relative p-0">
                ...
                <div class="p-md-3 py-3 text-center">
                    ...
                    <?php echo do_shortcode("[beli class='btn btn-sm btn-dark border-0 shadow-sm']");
                    ?>
                </div>
            </div>
        </div>
